...
tol = .2
counts=[100,1000,25000]
count = counts[int(proc_number/1000)]
Test.MultipleSweeps(iter_number=proc_number,n=1,expcounts=[count],Res=[10],Input_HL='HalflivesLin50.npy',tol=tol)
